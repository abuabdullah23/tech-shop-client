...
const SingleProduct = ({ product }) => {
    ...
    return (
        <div className='flex flex-col lg:flex-row lg:items-start gap-3 lg:gap-5 mt-12'>
            ...
            <div className='lg:w-3/5 w-full text-gray-500 dark:text-white'>
                <h2 className='text-2xl text-cyan-700 dark:text-cyan-300 font-semibold'>{name}</h2>
                <h4 className='text-lg mt-1'>Brand Name: {brandName}</h4>
                <h3 className='text-lg mt-1'>Type: {type}</h3>
                <h4 className='text-base font-semibold text-cyan-600 dark:text-cyan-300 mt-1'>Price: ${price}</h4>
